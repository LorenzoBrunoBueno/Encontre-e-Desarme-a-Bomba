...
const STEPS = [
  {
    ...
    title: 'Objetivo',
    body:
      'É uma linha de produção contínua de bombas — não existem fases. ' +
      'O tempo total da partida é oculto: não há contador na tela, então ' +
      'você não consegue "esperar parado" pra ver quanto falta.',
  },
  {
    icon: '📦',
    title: 'Dispenser',
    body:
      ...
      'Vá até a caixa de coleta e puxe a alavanca física pra soltá-la. ' +
      'Demorou demais? Ela cai sozinha mesmo assim.',
  },
  {
    icon: '📡',
    title: 'Scanner',
    body:
      ...
      '(fica preso na bomba) e o holograma no teto central se atualiza. ' +
      'A cada 3 bombas escaneadas o scanner superaquece: resolva puxando a ' +
      'alavanca de purga no centro da sala (3 puxões).',
  },
  {
    icon: '🔧',
    title: 'Mesa de desarme',
    body:
      'Coloque a bomba na mesa e entre no modo de desarme (locomoção trava ' +
      'enquanto durar). O alicate (cinto, lado direito) corta o fio certo; ' +
      'o botão certo fica entre 4 cores; a senha é numérica de 4 dígitos. ' +
      'Um botão dedicado gira a bomba 180° pra etapa traseira (4 parafusos ' +
      'com a chave de fenda do cinto + núcleo — opcional, não afeta a nota).',
  },
  {
    icon: '🛫',
    title: 'Esteira',
    body:
      ...
      'esteira pra entregá-la. Se retirou o núcleo na etapa traseira, ' +
      'descarte no duto ao lado (arremessando ou só aproximando).',
  },
  {
    icon: '🏁',
    title: 'Pontuação',
    body:
      'Você não sabe na hora se acertou ou errou — o resultado de cada ' +
      'bomba só aparece no relatório final. Uma música de tensão nos ' +
      'últimos ~15s é o único aviso de que o tempo está acabando.',
  },
];
